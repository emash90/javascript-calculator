const initApp = () => {
    ...
    opButtons.forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            //ensure there is a number first
            ...
            if(itemArray.length) {
                ...
                const equationObj = {
                    ...
                    num2: parseFloat(currentVal), //3rd element
                    op: itemArray[1]
                }
                ...
                //start new equation without hitting =
    ...
    equalsButton.addEventListener('click', () => {
        ...
        //pressing the equals button repeatedly
